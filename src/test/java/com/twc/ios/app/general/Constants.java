...
public class Constants {
	...
	public final static String CHARLES_CONFIG_PATH = System.getProperty("charles-config-location",
			"./src/main/resources/charles_common.config");
	 ...
	 */
	public final static String BROWSER_STACK_USER = "nvnsrao";
	public final static String BROWSER_STACK_TOKEN = "asdf0123456";
