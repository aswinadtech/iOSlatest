...
import com.twc.ios.app.general.CommandRunner;
import com.twc.ios.app.general.Constants;
...
public class CharlesProxy extends Functions{
	...
	private final String username = "nvnsrao";
	private final String password = "nvnsrao";
	...
	/**
	 * Genearates Charles Session File
	 */
	public File getXml() throws Exception {
		...
		final String filePath = System.getProperty("user.dir") + ReadExcelValues.data[4][1];
	...
	public void enableNoCache() {
		this.executeCommand(this.CHARLES_URL + CharlesOption.NOCACHE.getPath() + "enable");
	}

	public void disableNoCache() {
		this.executeCommand(this.CHARLES_URL + CharlesOption.NOCACHE.getPath() + "disable");
	}

	/**
	 * This method clears the Current Charles Session
	 */
	public void clearCharlesSession() {
		this.executeCommand(this.CHARLES_URL + CharlesOption.SESSION.getPath() + "clear");
		System.out.println("Charles Session cleared");
		logStep("Charles Session cleared");
	}
