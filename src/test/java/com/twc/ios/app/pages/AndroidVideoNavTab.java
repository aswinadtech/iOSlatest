...
public class AndroidVideoNavTab extends Utils{
	AppiumDriver<MobileElement> Ad;
	String videoDetailTab_AccessibilityId = "Videos Tab";
	...
	//By byVideoTabFallback = MobileBy.xpath("(//android.widget.TextView[@resource-id=\"com.weather.Weather:id/navigation_bar_item_small_label_view\"])[4]");
	By byVideoTabFallback = MobileBy.xpath("(//android.widget.FrameLayout[@resource-id='com.weather.Weather:id/navigation_bar_item_icon_container'])[5]");
	

	MobileElement videoNavTab = null;
	

	public AndroidVideoNavTab(AppiumDriver<MobileElement> Ad) {
		this.Ad = Ad;
	}
	...
	@Step("Navigate to Video tab and Handle Exit interstitial")
	public void navigateToVideoTabAndHandleInterstitialAd() throws Exception {
		...
		if (interStitialAdcallSuccessful) {
			/**
			 * Since Video has Exit Interstitial, handling it once navigated to Video Tab and click on Home Tab
			 */
