...
public class AndroidSeasonalHubCardScreen extends Utils {
	...
	String seasonalHubCardFirstIndex_Xpath = "(//android.widget.TextView[@text='Outdoor Conditions']/following-sibling::android.widget.ViewAnimator//android.widget.LinearLayout[@resource-id='com.weather.Weather:id/list_view']/android.widget.RelativeLayout)[1]";
	...
	String seasonalHubCardAllIndexes_Xpath = "//android.widget.TextView[@text='Outdoor Conditions']/following-sibling::android.widget.ViewAnimator//android.widget.LinearLayout[@resource-id='com.weather.Weather:id/list_view']/android.widget.RelativeLayout";
	//String seasonalHubCardDynamicIndex_Xpath = "//XCUIElementTypeOther[@name='seasonal-hub-card-containerView']//XCUIElementTypeCell[";
	String seasonalHubCardDynamicIndex_Xpath = "(//android.widget.TextView[@text='Outdoor Conditions']/following-sibling::android.widget.ViewAnimator//android.widget.LinearLayout[@resource-id='com.weather.Weather:id/list_view']/android.widget.RelativeLayout)[";
	...
	public AndroidSeasonalHubCardScreen(AppiumDriver<MobileElement> Ad) {
		this.Ad = Ad;
	}
	...
	public void verifyPubadCal_SeasonalHub(String excelName, String sheetName) throws Exception {
		...
		for (int m = 1; m <= shsize; m++) {
			...
			By bySeasonalHubCardDynamicIndexLabel = MobileBy.xpath(""+seasonalHubCardDynamicIndex_Xpath + m + "]/android.widget.TextView[@resource-id=\"com.weather.Weather:id/card_dial_index"+m+"_heading\"]");
			...
			String currentIndex = seasonalHubCardDynamicIndexLabel.getAttribute("text");
