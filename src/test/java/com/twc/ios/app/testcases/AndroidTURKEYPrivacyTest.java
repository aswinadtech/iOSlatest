...
public class AndroidTURKEYPrivacyTest extends TwcIosBaseTest {
	// private static final MobileAutomationLogger LOGGER = new
	// MobileAutomationLogger(TURKEYFunctionalEULaunchTests.class);
	private static final String CONFIG_FILE_PATH = "enableTURKEY.config";
	...
	public void beforeClass() {
		System.out.println("****** TURKEY Privacy Test Started");
		logStep("****** TURKEY Privacy Test Started");
		this.configFile = this.rewriteRuleToEnableTURKEYAndroid(CONFIG_FILE_PATH);
	...
	public void afterClass() throws Exception {
		...
		System.out.println("****** TURKEY Privacy Test Ended");
		logStep("****** TURKEY Privacy Test Ended");
		System.out.println("==============================================");
	}

/*	@Test(priority = -1)
	@Description("Download and Install App from Firebase")
	public void downloadAndInstallApp_for_TURKEY() throws Exception {
		System.out.println("==============================================");
	...
	@Test(priority = 0)
	@Description("Enable Preconditions for TURKEY")
	public void preConditionsTest_for_TURKEY() throws Exception {
		System.out.println("==============================================");
		System.out.println("****** PreConditions For TURKEY test case Started");
		logStep("****** PreConditions For TURKEY test case Started");
		// Preconditions
		Functions.capabilities();
		Functions.Appium_Autostart();
		...
		/* Preconditions
		 * as we are not uninstalling and installing, this step not requiredv
	...
	public void Verify_Lotame_Call_for_TURKEY() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_LocationWFXTriggers_Call__for_TURKEY() throws Exception {
		System.out.println("==============================================");
	...
	public void validate_NextGen_IM_call_npa_val_for_TURKEY() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_Criteo_SDK_inapp_v2_Call_for_TURKEY() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_Criteo_SDK_config_app_Call_for_TURKEY() throws Exception {
		System.out.println("==============================================");
	...
	public void derive_VideoCall_IU_for_TURKEY() throws Exception {
		
		System.out.println("==============================================");
		System.out.println("****** Deriving VideoCall For TURKEY test case Started");
		logStep("****** Deriving VideoCall For TURKEY test case Started");
	...
	public void validate_Video_call_npa_val_for_TURKEY() throws Exception {
		System.out.println("==============================================");
