...
public class AndroidLATAMPEPrivacyTest extends TwcIosBaseTest {
	// private static final MobileAutomationLogger LOGGER = new
	// MobileAutomationLogger(LATAMPEFunctionalEULaunchTests.class);
	...
	public void beforeClass() {
		...
		this.configFile = this.rewriteRuleToEnableLATAMPEAndroid(CONFIG_FILE_PATH);
	...
	public void downloadAndInstallApp_for_LATAMPE() throws Exception {
		System.out.println("==============================================");
	...
	@Test(priority = 0)
	@Description("Enable Preconditions for LATAMPE")
	public void preConditionsTest_for_LATAMPE() throws Exception {
		System.out.println("==============================================");
		System.out.println("****** PreConditions For LATAMPE test case Started");
		logStep("****** PreConditions For LATAMPE test case Started");
		// Preconditions
		Functions.capabilities();
		Functions.Appium_Autostart();
	...
	public void Verify_Lotame_Call_for_LATAMPE() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_LocationWFXTriggers_Call__for_LATAMPE() throws Exception {
		System.out.println("==============================================");
	...
	public void validate_NextGen_IM_call_npa_val_for_LATAMPE() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_Criteo_SDK_inapp_v2_Call_for_LATAMPE() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_Criteo_SDK_config_app_Call_for_LATAMPE() throws Exception {
		System.out.println("==============================================");
	...
	public void derive_VideoCall_IU_for_LATAMPE() throws Exception {
		
		System.out.println("==============================================");
		System.out.println("****** Deriving VideoCall For LATAMPE test case Started");
		logStep("****** Deriving VideoCall For LATAMPE test case Started");
	...
	public void validate_Video_call_npa_val_for_LATAMPE() throws Exception {
		System.out.println("==============================================");
