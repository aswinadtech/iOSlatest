...
public class AndroidRUSSIAPrivacyTest extends TwcIosBaseTest {
	// private static final MobileAutomationLogger LOGGER = new
	// MobileAutomationLogger(GDPRFunctionalEULaunchTests.class);
	private static final String CONFIG_FILE_PATH = "enableRUSSIA.config";
	...
	public void beforeClass() {
		System.out.println("****** RUSSIA Privacy Test Started");
		logStep("****** RUSSIA Privacy Test Started");
		this.configFile = this.rewriteRuleToEnableRUSSIAAndroid(CONFIG_FILE_PATH);
	...
	public void afterClass() throws Exception {
		...
		System.out.println("****** RUSSIA Privacy Test Ended");
	...
	public void downloadAndInstallApp_for_RUSSIA() throws Exception {
		System.out.println("==============================================");
	...
	@Test(priority = 0)
	@Description("Enable Preconditions for RUSSIA")
	public void preConditionsTest_for_RUSSIA() throws Exception {
		System.out.println("==============================================");
		System.out.println("****** PreConditions For RUSSIA test case Started");
		logStep("****** PreConditions For RUSSIA test case Started");
		// Preconditions
		Functions.capabilities();
		Functions.Appium_Autostart();
	...
	public void Verify_LocationWFXTriggers_Call_for_RUSSIA() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_Criteo_SDK_inapp_v2_Call_for_RUSSIA() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_Criteo_SDK_config_app_Call_for_RUSSIA() throws Exception {
		System.out.println("==============================================");
