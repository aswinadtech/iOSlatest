...
public class CriteoAndAmazonBidTest extends TwcIosBaseTest {
	...
	public void beforeClass() {
		...
		this.configFile = this.rewriteRuleToEnableUSAWhenNoTunnelBear(CRITEO_CONFIG_FILE_PATH, "usa", "US", "WA");
	...
	public void afterClass() throws Exception {
		...
		// Functions.select_Airlock_UserGroup("UnSelect");
	...
	public void Verify_Criteo_SDK_inapp_v2_Call_cpm_parameter_with_Hourly1_Big_ad_gampad_call() throws Exception {
		...
		Utils.validate_Criteo_SDK_inapp_v2_call_param_value_with_gampad_param_value("Smoke", "Hourly1", "cpm", true, 1,
				true);
	}
	...
	public void Verify_Criteo_SDK_inapp_v2_Call_size_parameter_with_Hourly1_Big_ad_gampad_call() throws Exception {
		...
		Utils.validate_Criteo_SDK_inapp_v2_call_param_value_with_gampad_param_value("Smoke", "Hourly1", "size", true, 1,
				true);
	}
	...
	public void Verify_Criteo_SDK_inapp_v2_Call_displayUrl_parameter_with_Hourly1_Big_ad_gampad_call()
		...
		Utils.validate_Criteo_SDK_inapp_v2_call_param_value_with_gampad_param_value("Smoke", "Hourly1", "displayUrl",
				true, 1, true);
	}
	...
	public void Verify_Criteo_SDK_inapp_v2_Call_cpm_parameter_with_Hourly2_Big_ad_gampad_call() throws Exception {
		...
		Utils.validate_Criteo_SDK_inapp_v2_call_param_value_with_gampad_param_value("Smoke", "Hourly2", "cpm", true, 2,
				true);
	}
	...
	public void Verify_Criteo_SDK_inapp_v2_Call_size_parameter_with_Hourly2_Big_ad_gampad_call() throws Exception {
		...
		Utils.validate_Criteo_SDK_inapp_v2_call_param_value_with_gampad_param_value("Smoke", "Hourly2", "size", true, 2,
				true);
	}
	...
	public void Verify_Criteo_SDK_inapp_v2_Call_displayUrl_parameter_with_Hourly2_Big_ad_gampad_call()
		...
		Utils.validate_Criteo_SDK_inapp_v2_call_param_value_with_gampad_param_value("Smoke", "Hourly2", "displayUrl",
				true, 2, true);
	}
	...
	public void Verify_Criteo_SDK_inapp_v2_Call_cpm_parameter_with_Hourly3_Big_ad_gampad_call() throws Exception {
		...
		Utils.validate_Criteo_SDK_inapp_v2_call_param_value_with_gampad_param_value("Smoke", "Hourly3", "cpm", true, 3,
				true);
	}
	...
	public void Verify_Criteo_SDK_inapp_v2_Call_size_parameter_with_Hourly3_Big_ad_gampad_call() throws Exception {
		...
		Utils.validate_Criteo_SDK_inapp_v2_call_param_value_with_gampad_param_value("Smoke", "Hourly3", "size", true, 3,
				true);
	}
	...
	public void Verify_Criteo_SDK_inapp_v2_Call_displayUrl_parameter_with_Hourly3_Big_ad_gampad_call()
		...
		Utils.validate_Criteo_SDK_inapp_v2_call_param_value_with_gampad_param_value("Smoke", "Hourly3", "displayUrl",
				true, 3, true);
	}
