...
public class SuppressAdsByGeoLocationTest_FullLocationsVerification extends TwcIosBaseTest {
	...
	@Test(priority = 200)
	@Description("Enable Preconditions for CU")
	public void preConditionsTest_for_CU() throws Exception {
		System.out.println("==============================================");
		System.out.println("****** PreConditions for CU test case Started");
		logStep("****** PreConditions for CU test case Started");
		proxy.clearCharlesSession();
		/* Preconditions
		 * as we are not uninstalling and installing, this step not required
		Utils.getCurrentMacIPAddressAndSetiPhoneProxy(true, true);*/
		...
		Functions.archive_folder("Charles");
		proxy.clearCharlesSession();
		Ad.setLocation(new Location(21.521757, -77.781167, 15));
		Functions.close_launchApp();
		Functions.checkForAppState();
		proxy.clearCharlesSession();
		Functions.close_launchApp();
	...
	@Description("Factual Call verification")
	public void Verify_LocationWFXTriggers_Call_for_CU() throws Exception {
		System.out.println("==============================================");
		System.out.println("****** location.wfxtriggers.com Call test case Started");
		logStep("location.wfxtriggers.com Call test case Started");
		Utils.verifyAPICal("Smoke", "LocationWFX", false);
	...
	@Description("Deriving Video Call")
	public void derive_VideoCall_IU_for_CU() throws Exception {
	...
	@Test(priority = 300)
	@Description("Enable Preconditions for IR")
	public void preConditionsTest_for_IR() throws Exception {
		System.out.println("==============================================");
		System.out.println("****** PreConditions for IR test case Started");
		logStep("****** PreConditions for IR test case Started");
		proxy.clearCharlesSession();
		/* Preconditions
		 * as we are not uninstalling and installing, this step not required
		Utils.getCurrentMacIPAddressAndSetiPhoneProxy(true, true);*/
		...
		Functions.archive_folder("Charles");
		proxy.clearCharlesSession();
		Ad.setLocation(new Location(32.427908, 53.688046, 15));
		Functions.close_launchApp();
		Functions.checkForAppState();
		proxy.clearCharlesSession();
		Functions.close_launchApp();
	...
	@Description("Factual Call verification")
	public void Verify_LocationWFXTriggers_Call_for_IR() throws Exception {
		System.out.println("==============================================");
		System.out.println("****** location.wfxtriggers.com Call test case Started");
		logStep("location.wfxtriggers.com Call test case Started");
		Utils.verifyAPICal("Smoke", "LocationWFX", false);
	...
	@Description("Deriving Video Call")
	public void derive_VideoCall_IU_for_IR() throws Exception {
	...
	@Test(priority = 400)
	@Description("Enable Preconditions for KP")
	public void preConditionsTest_for_KP() throws Exception {
		System.out.println("==============================================");
		System.out.println("****** PreConditions for KP test case Started");
		logStep("****** PreConditions for KP test case Started");
		proxy.clearCharlesSession();
		/* Preconditions
		 * as we are not uninstalling and installing, this step not required
		Utils.getCurrentMacIPAddressAndSetiPhoneProxy(true, true);*/
		...
		Functions.archive_folder("Charles");
		proxy.clearCharlesSession();
		Ad.setLocation(new Location(40.339852, 127.510093, 15));
		Functions.close_launchApp();
		Functions.checkForAppState();
		proxy.clearCharlesSession();
		Functions.close_launchApp();
	...
	@Description("Factual Call verification")
	public void Verify_LocationWFXTriggers_Call_for_KP() throws Exception {
		System.out.println("==============================================");
		System.out.println("****** location.wfxtriggers.com Call test case Started");
		logStep("location.wfxtriggers.com Call test case Started");
		Utils.verifyAPICal("Smoke", "LocationWFX", false);
	...
	@Description("Deriving Video Call")
	public void derive_VideoCall_IU_for_KP() throws Exception {
	...
	@Test(priority = 500)
	@Description("Enable Preconditions for SD")
	public void preConditionsTest_for_SD() throws Exception {
		System.out.println("==============================================");
		System.out.println("****** PreConditions for SD test case Started");
		logStep("****** PreConditions for SD test case Started");
		proxy.clearCharlesSession();
		/* Preconditions
		 * as we are not uninstalling and installing, this step not required
		Utils.getCurrentMacIPAddressAndSetiPhoneProxy(true, true);*/
		...
		Functions.archive_folder("Charles");
		proxy.clearCharlesSession();
		Ad.setLocation(new Location(12.862807, 30.217636, 15));
		Functions.close_launchApp();
		Functions.checkForAppState();
		proxy.clearCharlesSession();
		Functions.close_launchApp();
	...
	@Description("Factual Call verification")
	public void Verify_LocationWFXTriggers_Call_for_SD() throws Exception {
		System.out.println("==============================================");
		System.out.println("****** location.wfxtriggers.com Call test case Started");
		logStep("location.wfxtriggers.com Call test case Started");
		Utils.verifyAPICal("Smoke", "LocationWFX", false);
	...
	@Description("Deriving Video Call")
	public void derive_VideoCall_IU_for_SD() throws Exception {
	...
	@Test(priority = 600)
	@Description("Enable Preconditions for SY")
	public void preConditionsTest_for_SY() throws Exception {
		System.out.println("==============================================");
		System.out.println("****** PreConditions for SY test case Started");
		logStep("****** PreConditions for SY test case Started");
		proxy.clearCharlesSession();
		/* Preconditions
		 * as we are not uninstalling and installing, this step not required
		Utils.getCurrentMacIPAddressAndSetiPhoneProxy(true, true);*/
		...
		Functions.archive_folder("Charles");
		proxy.clearCharlesSession();
		Ad.setLocation(new Location(34.802075, 38.996815, 15));
		Functions.close_launchApp();
		Functions.checkForAppState();
		proxy.clearCharlesSession();
		Functions.close_launchApp();
	...
	@Description("Factual Call verification")
	public void Verify_LocationWFXTriggers_Call_for_SY() throws Exception {
		System.out.println("==============================================");
		System.out.println("****** location.wfxtriggers.com Call test case Started");
		logStep("location.wfxtriggers.com Call test case Started");
		Utils.verifyAPICal("Smoke", "LocationWFX", false);
	...
	@Description("Deriving Video Call")
	public void derive_VideoCall_IU_for_SY() throws Exception {
		System.out.println("==============================================");
		System.out.println("****** Video Call verification test case Started");
		logStep("****** Video Call verification test case Started");
		hmTab.clickonHomeTab();
