...
public class AndroidLATAMDOPrivacyTest extends TwcIosBaseTest {
	// private static final MobileAutomationLogger LOGGER = new
	// MobileAutomationLogger(LATAMDOFunctionalEULaunchTests.class);
	private static final String CONFIG_FILE_PATH = "enableLATAMDO.config";
	...
	public void beforeClass() {
		System.out.println("****** LATAM-DO Privacy Test Started");
		logStep("****** LATAM-DO Privacy Test Started");
		this.configFile = this.rewriteRuleToEnableLATAMDOAndroid(CONFIG_FILE_PATH);
	...
	public void afterClass() throws Exception {
		...
		System.out.println("****** LATAM-DO Privacy Test Ended");
		logStep("****** LATAM-DO Privacy Test Ended");
		System.out.println("==============================================");
	}
	...
	public void downloadAndInstallApp_for_LATAMDO() throws Exception {
		System.out.println("==============================================");
	...
	@Test(priority = 0)
	@Description("Enable Preconditions for LATAMDO")
	public void preConditionsTest_for_LATAMDO() throws Exception {
		System.out.println("==============================================");
		System.out.println("****** PreConditions For LATAMDO test case Started");
		logStep("****** PreConditions For LATAMDO test case Started");
		// Preconditions
		Functions.capabilities();
		Functions.Appium_Autostart();
	...
	public void Verify_Lotame_Call_for_LATAMDO() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_LocationWFXTriggers_Call__for_LATAMDO() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_WFXTriggers_Call_for_LATAMDO() throws Exception {
		System.out.println("==============================================");
	...
	public void validate_NextGen_IM_call_npa_val_for_LATAMDO() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_Criteo_SDK_inapp_v2_Call_for_LATAMDO() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_Criteo_SDK_config_app_Call_for_LATAMDO() throws Exception {
		System.out.println("==============================================");
	...
	public void derive_VideoCall_IU_for_LATAMDO() throws Exception {
		
		System.out.println("==============================================");
		System.out.println("****** Deriving VideoCall For LATAMDO test case Started");
		logStep("****** Deriving VideoCall For LATAMDO test case Started");
	...
	public void validate_Video_call_npa_val_for_LATAMDO() throws Exception {
		System.out.println("==============================================");
