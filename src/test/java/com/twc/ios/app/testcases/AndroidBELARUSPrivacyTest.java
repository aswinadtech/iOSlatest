...
public class AndroidBELARUSPrivacyTest extends TwcIosBaseTest {
	// private static final MobileAutomationLogger LOGGER = new
	// MobileAutomationLogger(GDPRFunctionalEULaunchTests.class);
	private static final String CONFIG_FILE_PATH = "enableBELARUS.config";
	...
	public void beforeClass() {
		System.out.println("****** BELARUS Privacy Test Started");
		logStep("****** BELARUS Privacy Test Started");
		this.configFile = this.rewriteRuleToEnableBELARUSAndroid(CONFIG_FILE_PATH);
	...
	public void afterClass() throws Exception {
		...
		System.out.println("****** BELARUS Privacy Test Ended");
		logStep("****** BELARUS Privacy Test Ended");
		System.out.println("==============================================");
	}
	
	
	@Test(priority = 0)
	@Description("Enable Preconditions for BELARUS")
	public void preConditionsTest_for_BELARUS() throws Exception {
		System.out.println("==============================================");
		System.out.println("****** PreConditions For BELARUS test case Started");
		logStep("****** PreConditions For BELARUS test case Started");
		// Preconditions
		...
		Functions.archive_folder("Charles");
		Functions.launchtheAppForChinaORRussiaORBelarusAndroid("true");
		...
		try {
			...
			Functions.checkForAppStateNotEqualAndroid(ApplicationState.RUNNING_IN_FOREGROUND);
		}finally {
			proxy.getXml();
	...
	public void Verify_Lotame_Call_for_BELARUS() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_LocationWFXTriggers_Call_for_BELARUS() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_WFXTriggers_Call_or_BELARUS() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_Criteo_SDK_inapp_v2_Call_for_BELARUS() throws Exception {
		System.out.println("==============================================");
	...
	public void Verify_Criteo_SDK_config_app_Call_for_BELARUS() throws Exception {
		System.out.println("==============================================");
