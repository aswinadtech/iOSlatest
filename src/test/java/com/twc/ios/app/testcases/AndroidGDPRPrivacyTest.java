...
public class AndroidGDPRPrivacyTest extends TwcIosBaseTest {
	...
	public void beforeClass() {
		...
		this.configFile = this.rewriteRuleToEnableGDPRAndroid(CONFIG_FILE_PATH);
	...
	public void downloadAndInstallApp_for_GDPR() throws Exception {
		System.out.println("==============================================");
	...
	@Test(priority = 0)
	@Description("Enable Preconditions for GDPR")
	public void preConditionsTest_for_GDPR() throws Exception {
		System.out.println("==============================================");
		System.out.println("****** PreConditions For GDPR test case Started");
		logStep("****** PreConditions For GDPR test case Started");
	...
	public void derive_VideoCall_IU_for_GDPR() throws Exception {
		
		System.out.println("==============================================");
		System.out.println("****** Deriving VideoCall For GDPR test case Started");
		logStep("****** Deriving VideoCall For GDPR test case Started");
