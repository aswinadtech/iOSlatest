...
public class AndroidUSAPrivacyTest extends TwcIosBaseTest {
	...
	public void beforeClass() {
		...
		this.configFile = this.rewriteRuleToEnableUSAAndroid(CONFIG_FILE_PATH);
	...
	public void enable_PreConfiguration_for_USA_To_USACCPA_Travel_Scenario() throws Exception {
		...
		proxy.quitCharlesProxy();
		this.configFile = this.rewriteRuleToEnableUSACCPAAndroid(USACCPA_CONFIG_FILE_PATH);
