...
public class TWCNativeAndroidAdValidation extends TwcIosBaseTest {
...
//		Utils.getCurrentMacIPAddressAndSetiPhoneProxy(true, true);
		...
		capabilities.setCapability("appPackage", "com.weather.performancenative");

		capabilities.setCapability("appActivity", "com.weather.performancenative.MainActivity");
	...
	public void validating_Interstitial_Ad() throws Exception {
		...
		for (int i = 1; i <= 50; i++) {
			try {
				...
				Ad.findElementById("com.weather.performancenative:id/interstitial_ad").click();
	...
	public void validating_Marquee_Static_Ad() throws Exception {
		...
		for (int i = 1; i <= 50; i++) {
			try {
				...
				// Static Marque
				Ad.findElementById("com.weather.performancenative:id/integrated_ad").click();
				long start = System.currentTimeMillis();
	...
	public void validating_Marquee_Video_Ad() throws Exception {
		...
		for (int i = 1; i <= 50; i++) {
			try {
				...
				// Video Marque
				Ad.findElementById("com.weather.performancenative:id/integrated_ad_video").click();
				long start = System.currentTimeMillis();
	...
	public void validating_Small_Banner_Ad() throws Exception {
		...
		for (int i = 1; i <= 50; i++) {
			try {
				...
				// Video Marque
				Ad.findElementById("com.weather.performancenative:id/banner_small").click();
				long start = System.currentTimeMillis();
	...
	public void validating_Large_Banner_Ad() throws Exception {
		...
		for (int i = 1; i <= 50; i++) {
			try {
				...
				// Video Marque
				Ad.findElementById("com.weather.performancenative:id/banner_big").click();
				long start = System.currentTimeMillis();
