...
public class AndroidUSACCPAPrivacyTest extends TwcIosBaseTest {
	...
	public void beforeClass() {
		System.out.println("****** USACCPA Privacy Test Started");
		logStep("****** USACCPA Privacy Test Started");
		this.configFile = this.rewriteRuleToEnableUSACCPAAndroid(CONFIG_FILE_PATH);
	...
	public void afterClass() throws Exception {
		...
		System.out.println("****** USACCPA Privacy Test Ended");
		logStep("****** USACCPA Privacy Test Ended");
		System.out.println("==============================================");
	}
...
/*	@Test(priority = -1)
	...
	public void downloadAndInstallApp_for_USACCPA() throws Exception {
		System.out.println("==============================================");
	...
	@Test(priority = 0)
	@Description("Enable Preconditions for USACCPA")
	public void preConditionsTest_for_USACCPA() throws Exception {
		System.out.println("==============================================");
		System.out.println("****** PreConditions For USACCPA test case Started");
		logStep("****** PreConditions For USACCPA test case Started");
		// Preconditions
		Functions.capabilities();
		Functions.Appium_Autostart();
	 ...
	 */
	  ...
	  verify_enabling_Privacy_optin_for_USACCPA() throws Exception {
	  System.out.println("==============================================");
	  System.out.
	...
	public void navigate_To_Feed_Cards_when_Privacy_optin_for_USACCPA() throws Exception {
		System.out.println("==============================================");
...
/*	@Test(priority = 20, enabled = true)
	...
	public void verify_Hourly_details_call_sod_val_privacy_optin_for_USACCPA() throws Exception {
		System.out.println("==============================================");
	...
	public void verify_Daily_details_call_sod_val_privacy_optin_for_USACCPA() throws Exception {
		System.out.println("==============================================");
	...
	public void verify_enabling_Privacy_optout_for_USACCPA() throws Exception {
		System.out.println("==============================================");
	...
	public void navigate_To_Feed_Cards_when_Privacy_optout_for_USACCPA() throws Exception {
		System.out.println("==============================================");
	...
	public void verify_Hourly_details_call_sod_val_privacy_optout_for_USACCPA() throws Exception {
		System.out.println("==============================================");
	...
	public void verify_Daily_details_call_sod_val_privacy_optout_for_USACCPA() throws Exception {
		System.out.println("==============================================");
	...
	public void enable_PreConfiguration_for_USACCPA_To_LGPD_Travel_Scenario() throws Exception {
		...
		proxy.quitCharlesProxy();
		this.configFile = this.rewriteRuleToEnableLGPDAndroid(LGPD_CONFIG_FILE_PATH);
	...
	@Description("Verify Hourly details page Call sod value when privacy optout for USACCPA To LGPD Travel Scenario")
	public void verify_Hourly_details_call_sod_val_privacy_optout_for_USACCPA_To_LGPD_Travel_Scenario() throws Exception {
		System.out.println("==============================================");

		System.out
				.println("****** Verify Hourly details Call sod value when privacy optout for USACCPA To LGPD Travel Scenario");
		logStep("Verify Hourly details Call sod value when privacy optout for USACCPA To LGPD Travel Scenario");
	...
	public void derive_VideoCall_IU_when_Privacy_optout_for_USACCPA_To_LGPD_Travel_Scenario() throws Exception {
		...
		logStep("****** Deriving VideoCall when privacy optout for USACCPA To LGPD Travel Scenario");
		hmTab.clickonHomeTab();
		hmTab.clickonHomeTab();
		Functions.archive_folder("Charles");
		proxy.clearCharlesSession();
	...
	public void enable_PreConfiguration_for_USACCPA_To_GDPR_Travel_Scenario() throws Exception {
		...
		proxy.quitCharlesProxy();
		this.configFile = this.rewriteRuleToEnableGDPRAndroid(GDPR_CONFIG_FILE_PATH);
	...
	@Description("Verify Hourly details page Call sod value when privacy optout for USACCPA To GDPR Travel Scenario")
	public void verify_Hourly_details_call_sod_val_privacy_optout_for_USACCPA_To_GDPR_Travel_Scenario() throws Exception {
		System.out.println("==============================================");

		System.out
				.println("****** Verify Hourly details Call sod value when privacy optout for USACCPA To GDPR Travel Scenario");
		logStep("Verify Hourly details Call sod value when privacy optout for USACCPA To GDPR Travel Scenario");
	...
	public void derive_VideoCall_IU_when_Privacy_optout_for_USACCPA_To_GDPR_Travel_Scenario() throws Exception {
		...
		logStep("****** Deriving VideoCall when privacy optout for USACCPA To GDPR Travel Scenario");
		hmTab.clickonHomeTab();
		hmTab.clickonHomeTab();
		Functions.archive_folder("Charles");
		proxy.clearCharlesSession();
	...
	public void enable_PreConfiguration_for_USACCPA_To_SERBIA_Travel_Scenario() throws Exception {
		...
		proxy.quitCharlesProxy();
		this.configFile = this.rewriteRuleToEnableSERBIAAndroid(SERBIA_CONFIG_FILE_PATH);
	...
	@Description("Verify Hourly details page Call sod value when privacy optout for USACCPA To SERBIA Travel Scenario")
	public void verify_Hourly_details_call_sod_val_privacy_optout_for_USACCPA_To_SERBIA_Travel_Scenario() throws Exception {
		System.out.println("==============================================");

		System.out
				.println("****** Verify Hourly details Call sod value when privacy optout for USACCPA To SERBIA Travel Scenario");
		logStep("Verify Hourly details Call sod value when privacy optout for USACCPA To SERBIA Travel Scenario");
	...
	public void derive_VideoCall_IU_when_Privacy_optout_for_USACCPA_To_SERBIA_Travel_Scenario() throws Exception {
		...
		logStep("****** Deriving VideoCall when privacy optout for USACCPA To SERBIA Travel Scenario");
		hmTab.clickonHomeTab();
		hmTab.clickonHomeTab();
		Functions.archive_folder("Charles");
		proxy.clearCharlesSession();
	...
	@Description("Enabling Preconfiguration for USACCPA To LATAMCO Travel Scenario")
	public void enable_PreConfiguration_for_USACCPA_To_LATAMCO_Travel_Scenario() throws Exception {
		...
		proxy.quitCharlesProxy();
		this.configFile = this.rewriteRuleToEnableLATAMCOAndroid(LATAMCO_CONFIG_FILE_PATH);
	...
	@Description("Navigating to Feed Cards when privacy optout for USACCPA To LATAMCO Travel Scenario")
	public void navigate_To_Feed_Cards_when_Privacy_optout_for_USACCPA_To_LATAMCO_Travel_Scenario() throws Exception {
		System.out.println("==============================================");

		System.out.println("****** Navigating to Feed Cards when privacy optout for USACCPA To LATAMCO Travel Scenario");
		logStep("Navigating to Feed Cards when privacy optout for USACCPA To LATAMCO Travel Scenario");
	...
	@Description("Verify NextGen IM ad call sod value when privacy optout for USACCPA To LATAMCO Travel Scenario")
	public void validate_NextGen_IM_Adcall_sod_val_privacy_optout_for_USACCPA_To_LATAMCO_Travel_Scenario() throws Exception {
		System.out.println("==============================================");
	
		System.out.println("****** Verify NextGen IM Adcall sod value when privacy optout for USACCPA To LATAMCO Travel Scenario");
		logStep("Verify NextGen IM Adcall sod value when privacy optout for USACCPA To LATAMCO Travel Scenario");
	...
	@Description("Verify Hourly details page Call sod value when privacy optout for USACCPA To LATAMCO Travel Scenario")
	public void verify_Hourly_details_call_sod_val_privacy_optout_for_USACCPA_To_LATAMCO_Travel_Scenario() throws Exception {
		System.out.println("==============================================");

		System.out
				.println("****** Verify Hourly details Call sod value when privacy optout for USACCPA To LATAMCO Travel Scenario");
		logStep("Verify Hourly details Call sod value when privacy optout for USACCPA To LATAMCO Travel Scenario");
	...
	@Description("Amazon aax call verification when privacy optout for USACCPA To LATAMCO Travel Scenario")
	public void Verify_Amazon_Call_privacy_optout_for_USACCPA_To_LATAMCO_Travel_Scenario() throws Exception {
		System.out.println("==============================================");
		System.out.println("****** amazon-adsystem.com Call test case Started when privacy optout for USACCPA To LATAMCO Travel Scenario");
		logStep("****** amazon-adsystem.com Call test case Started when privacy optout for USACCPA To LATAMCO Travel Scenario");
		Utils.verify_Amazon_aax_call("Smoke", "Amazon", false);
	}
	...
	@Description("Lotame Call when privacy optout for USACCPA To LATAMCO Travel Scenario")
	public void Verify_Lotame_Call_privacy_optout_for_USACCPA_To_LATAMCO_Travel_Scenario() throws Exception {
		System.out.println("==============================================");
		System.out.println("****** Lotame Call test case Started when privacy optout for USACCPA To LATAMCO Travel Scenario");
		logStep("****** Lotame Call test case Started when privacy optout for USACCPA To LATAMCO Travel Scenario");
	...
	@Description("Factual Call when privacy optout for USACCPA To LATAMCO Travel Scenario")
	public void Verify_LocationWFXTriggers_Call_privacy_optout_for_USACCPA_To_LATAMCO_Travel_Scenario() throws Exception {
		System.out.println("==============================================");
		System.out.println(
				"****** location.wfxtriggers.com Call test case Started when privacy optout for USACCPA To LATAMCO Travel Scenario");
		logStep("location.wfxtriggers.com Call test case Started when privacy optout for USACCPA To LATAMCO Travel Scenario");
		Utils.verifyAPICal("Smoke", "LocationWFX", false);

	}

	@Test(priority = 535, enabled = true)
	@Description("Validating NextGen IM Call rdp value when privacy optout for USACCPA To LATAMCO Travel Scenario")
	public void validate_NextGen_IM_call_rdp_val_privacy_optout_for_USACCPA_To_LATAMCO_Travel_Scenario() throws Exception {
		System.out.println("==============================================");
		System.out
				.println("****** Validating NextGenIM Call rdp value when privacy optout for USACCPA To LATAMCO Travel Scenario");
		logStep("Validating NextGenIM Call rdp value when privacy optout for USACCPA To LATAMCO Travel Scenario ");
	...
	@Description("Validating NextGen IM Call npa value for USACCPA To LATAMCO Travel Scenario")
	public void validate_NextGen_IM_call_npa_val_privacy_optout_for_USACCPA_To_LATAMCO_Travel_Scenario() throws Exception {
		System.out.println("==============================================");
		System.out.println("****** Validating NextGen IM Call npa value for USACCPA To LATAMCO Travel Scenario");
		logStep("Validating NextGen IM Call npa value for USACCPA To LATAMCO Travel Scenario ");
	...
	@Description("Verify Criteo SDK inapp v2 call when privacy optout for USACCPA To LATAMCO Travel Scenario")
	...
	@Description("Verify Criteo SDK config app call when privacy optout for USACCPA To LATAMCO Travel Scenario")
	...
	@Description("Deriving Video Call when privacy optout for USACCPA To LATAMCO Travel Scenario")
	public void derive_VideoCall_IU_when_Privacy_optout_for_USACCPA_To_LATAMCO_Travel_Scenario() throws Exception {

		System.out.println("==============================================");
		System.out.println("****** Deriving VideoCall when privacy optout for USACCPA To LATAMCO Travel Scenario");
		logStep("****** Deriving VideoCall when privacy optout for USACCPA To LATAMCO Travel Scenario");
		hmTab.clickonHomeTab();
		hmTab.clickonHomeTab();
		Functions.archive_folder("Charles");
		proxy.clearCharlesSession();
	...
	@Description("Verify Preroll ad on Video Call sod value when privacy optout for USACCPA To LATAMCO Travel Scenario")
	public void verify_PrerollAd_call_sod_val_privacy_optout_for_USACCPA_To_LATAMCO_Travel_Scenario() throws Exception {
		System.out.println("==============================================");
		// Functions.retryclear();

		System.out.println("****** Prerol-video Call sod value when privacy optout for USACCPA To LATAMCO Travel Scenario");
		logStep("Verify Prerol-video Call sod value when privacy optout for USACCPA To LATAMCO Travel Scenario");
	...
	@Description("Validating Video Call npa value for USACCPA To LATAMCO Travel Scenario")
	public void validate_Video_call_npa_val_privacy_optout_for_USACCPA_To_LATAMCO_Travel_Scenario() throws Exception {
		System.out.println("==============================================");
		System.out.println("****** Validating Video Call npa value for USACCPA To LATAMCO Travel Scenario");
		logStep("Validating Video Call npa value for USACCPA To LATAMCO Travel Scenario ");
	...
	@Description("Validating Preroll Video Call rdp value when privacy optout for USACCPA To LATAMCO Travel Scenario")
	public void validate_PrerollVideo_call_rdp_val_privacy_optout_for_USACCPA_To_LATAMCO_Travel_Scenario() throws Exception {
		System.out.println("==============================================");
		System.out.println(
				"****** Validating PreRollVideo Call rdp value when privacy optout for USACCPA To LATAMCO Travel Scenario");
		logStep("Validating PreRollVideo Call rdp value when privacy optout for USACCPA To LATAMCO Travel Scenario ");
	...
	@Description("Enabling Preconfiguration for USACCPA To USA Travel Scenario")
	public void enable_PreConfiguration_for_USACCPA_To_USA_Travel_Scenario() throws Exception {
		System.out.println("==============================================");
		System.out.println("****** Enable Preconfiguration for USACCPA To USA Travel Scenario");
		logStep("Enable Preconfiguration for USACCPA To USA Travel Scenario");
		proxy.quitCharlesProxy();
		this.configFile = this.rewriteRuleToEnableUSAAndroid(USA_CONFIG_FILE_PATH);
		proxy = new CharlesProxy("localhost", 8111, USA_CONFIG_FILE_PATH);
		proxy.startCharlesProxyWithUI();
		proxy.enableRewriting();
		proxy.startRecording();
		proxy.disableMapLocal();
	...
	@Description("Navigating to Feed Cards when privacy optout for USACCPA To USA Travel Scenario")
	public void navigate_To_Feed_Cards_when_Privacy_optout_for_USACCPA_To_USA_Travel_Scenario() throws Exception {
		System.out.println("==============================================");

		System.out.println("****** Navigating to Feed Cards when privacy optout for USACCPA To USA Travel Scenario");
		logStep("Navigating to Feed Cards when privacy optout for USACCPA To USA Travel Scenario");
	...
	@Description("Verify NextGen IM ad call sod value when privacy optout for USACCPA To USA Travel Scenario")
	public void validate_NextGen_IM_Adcall_sod_val_privacy_optout_for_USACCPA_To_USA_Travel_Scenario() throws Exception {
		System.out.println("==============================================");
		// Functions.retryclear();

		System.out.println("****** Verify NextGen IM Adcall sod value when privacy optout for USACCPA To USA Travel Scenario");
		logStep("Verify NextGen IM Adcall sod value when privacy optout for USACCPA To USA Travel Scenario");
	...
	@Description("Verify Hourly details page Call sod value when privacy optout for USACCPA To USA Travel Scenario")
	public void verify_Hourly_details_call_sod_val_privacy_optout_for_USACCPA_To_USA_Travel_Scenario() throws Exception {
		System.out.println("==============================================");

		System.out
				.println("****** Verify Hourly details Call sod value when privacy optout for USACCPA To USA Travel Scenario");
		logStep("Verify Hourly details Call sod value when privacy optout for USACCPA To USA Travel Scenario");
	...
	@Description("Amazon aax call verification when privacy optout for USACCPA To USA Travel Scenario")
	public void Verify_Amazon_Call_privacy_optout_for_USACCPA_To_USA_Travel_Scenario() throws Exception {
		System.out.println("==============================================");
		System.out.println("****** amazon-adsystem.com Call test case Started when privacy optout for USACCPA To USA Travel Scenario");
		logStep("****** amazon-adsystem.com Call test case Started when privacy optout for USACCPA To USA Travel Scenario");
		Utils.verify_Amazon_aax_call("Smoke", "Amazon", false);
	}

	// Lotame Test case
	@Test(priority = 831, enabled = true)
	@Description("Lotame Call when privacy optout for USACCPA To USA Travel Scenario")
	public void Verify_Lotame_Call_privacy_optout_for_USACCPA_To_USA_Travel_Scenario() throws Exception {
		System.out.println("==============================================");
		System.out.println("****** Lotame Call test case Started when privacy optout for USACCPA To USA Travel Scenario");
		logStep("****** Lotame Call test case Started when privacy optout for USACCPA To USA Travel Scenario");
	...
	@Description("Factual Call when privacy optout for USACCPA To USA Travel Scenario")
	public void Verify_LocationWFXTriggers_Call_privacy_optout_for_USACCPA_To_USA_Travel_Scenario() throws Exception {
		System.out.println("==============================================");
		System.out.println(
				"****** location.wfxtriggers.com Call test case Started when privacy optout for USACCPA To USA Travel Scenario");
		logStep("location.wfxtriggers.com Call test case Started when privacy optout for USACCPA To USA Travel Scenario");
		Utils.verifyAPICal("Smoke", "LocationWFX", false);

	}

	@Test(priority = 835, enabled = true)
	@Description("Validating NextGen IM Call rdp value when privacy optout for USACCPA To USA Travel Scenario")
	public void validate_NextGen_IM_call_rdp_val_privacy_optout_for_USACCPA_To_USA_Travel_Scenario() throws Exception {
		System.out.println("==============================================");
		System.out
				.println("****** Validating NextGenIM Call rdp value when privacy optout for USACCPA To USA Travel Scenario");
		logStep("Validating NextGenIM Call rdp value when privacy optout for USACCPA To USA Travel Scenario ");
	...
	@Description("Verify Criteo SDK inapp v2 call when privacy optout for USACCPA To USA Travel Scenario")
	public void Verify_Criteo_SDK_inapp_v2_Call_privacy_optout_for_USACCPA_To_USA_Travel_Scenario() throws Exception {
		System.out.println("==============================================");
		System.out.println(
				"=========================== Criteo SDK inapp/v2 call when privacy optout for USACCPA To USA Travel Scenario====================");
		System.out.println(
				"****** Criteo SDK inapp/v2 call when privacy optout for USACCPA To USA Travel Scenario validation Started");
		logStep("****** Criteo SDK inapp/v2 call when privacy optout for USACCPA To USA Travel Scenario validation Started");
		Utils.verifyCriteo_inapp_v2_Call("Smoke", "Criteo", false);

	}

	@Test(priority = 851, enabled = true)
	@Description("Verify Criteo SDK config app call when privacy optout for USACCPA To USA Travel Scenario")
	public void Verify_Criteo_SDK_config_app_Call_privacy_optout_for_USACCPA_To_USA_Travel_Scenario() throws Exception {
		System.out.println("==============================================");
		System.out.println(
				"=========================== Criteo SDK config/app call when privacy optout for USACCPA To USA Travel Scenario====================");
		System.out.println(
				"****** Criteo SDK config/app call when privacy optout for USACCPA To USA Travel Scenario validation Started");
		logStep("****** Criteo SDK config/app call when privacy optout for USACCPA To USA Travel Scenario validation Started");
		Utils.verifyCriteo_config_app_Call("Smoke", "Criteo", false);

	}

	@Test(priority = 875, enabled = true)
	@Description("Deriving Video Call when privacy optout for USACCPA To USA Travel Scenario")
	public void derive_VideoCall_IU_when_Privacy_optout_for_USACCPA_To_USA_Travel_Scenario() throws Exception {

		System.out.println("==============================================");
		System.out.println("****** Deriving VideoCall when privacy optout for USACCPA To USA Travel Scenario");
		logStep("****** Deriving VideoCall when privacy optout for USACCPA To USA Travel Scenario");
		hmTab.clickonHomeTab();
		hmTab.clickonHomeTab();
		Functions.archive_folder("Charles");
		proxy.clearCharlesSession();
	...
	@Description("Verify Preroll ad on Video Call sod value when privacy optout for USACCPA To USA Travel Scenario")
	public void verify_PrerollAd_call_sod_val_privacy_optout_for_USACCPA_To_USA_Travel_Scenario() throws Exception {
		System.out.println("==============================================");
		
		System.out.println("****** Prerol-video Call sod value when privacy optout for USACCPA To USA Travel Scenario");
		logStep("Verify Prerol-video Call sod value when privacy optout for USACCPA To USA Travel Scenario");
	...
	@Description("Validating Preroll Video Call rdp value when privacy optout for USACCPA To USA Travel Scenario")
	public void validate_PrerollVideo_call_rdp_val_privacy_optout_for_USACCPA_To_USA_Travel_Scenario() throws Exception {
		System.out.println("==============================================");
		System.out.println(
				"****** Validating PreRollVideo Call rdp value when privacy optout for USACCPA To USA Travel Scenario");
		logStep("Validating PreRollVideo Call rdp value when privacy optout for USACCPA To USA Travel Scenario ");
